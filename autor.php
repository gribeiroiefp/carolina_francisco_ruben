    ...
    <div class="autor container-lg">
        <div class="row align-items-center">
            ...
            <div class="col-1 opcoes align-self-start">
                <a href="editar_autor.php?id=<?php echo htmlspecialchars($autor['id']) ?>" class="btn btn-primary btn-editar"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
                ...
                <form method="POST" onsubmit="return confirm('Tem certeza que deseja remover este livro?')">
                    <button type="submit" name= "delete_author" class="btn btn-danger btn-remover"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
